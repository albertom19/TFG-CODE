...
# Descriptive Statistics Plot (Histogram) for key variables
ggplot(data, aes(x = Income_Fluctuations)) +
  geom_histogram(binwidth = 0.5, fill = "blue", color = "black", alpha = 0.7) +
  labs(title = "Distribution of Income Fluctuations", x = "Income Fluctuations", y = "Frequency")

ggplot(data, aes(x = Recurring_Expenses)) +
  geom_histogram(binwidth = 0.5, fill = "green", color = "black", alpha = 0.7) +
  labs(title = "Distribution of Recurring Expenses", x = "Recurring Expenses", y = "Frequency")

# Boxplot to identify outliers
ggplot(data, aes(x = "", y = Income_Fluctuations)) +
  geom_boxplot(fill = "blue", alpha = 0.5) +
  labs(title = "Boxplot for Income Fluctuations", y = "Income Fluctuations")
